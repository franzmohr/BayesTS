...
#ifndef BAYESTS_IO_HDF5_VEC_NORMAL_WISHART_IO_H
#define BAYESTS_IO_HDF5_VEC_NORMAL_WISHART_IO_H
...
/// VecNormalWishartInput::validate(), where the message can name the field.
...
#endif // BAYESTS_IO_HDF5_VEC_NORMAL_WISHART_IO_H
