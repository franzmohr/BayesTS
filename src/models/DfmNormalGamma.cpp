...
void DfmNormalGamma::draw_coefficients(const std::filesystem::path &filepath_arg)
{
...
void DfmNormalGamma::forecast(const std::filesystem::path &filepath_arg)
{
    // Store filepath for later use
    this->filepath = filepath_arg;
...
void DfmNormalGamma::log_likelihood(const std::filesystem::path &filepath_arg)
{
    // Store filepath for later use
    this->filepath = filepath_arg;
