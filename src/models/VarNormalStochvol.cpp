...
void VarNormalStochvol::draw_coefficients(const std::filesystem::path &filepath_arg)
{
...
void VarNormalStochvol::forecast(const std::filesystem::path &filepath_arg)
{
    // Store filepath for later use
    this->filepath = filepath_arg;
...
void VarNormalStochvol::log_likelihood(const std::filesystem::path &filepath_arg)
{
    // Store filepath for later use
    this->filepath = filepath_arg;
