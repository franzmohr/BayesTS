...
void VecTvpWishart::draw_coefficients(const std::filesystem::path &filepath_arg)
{
...
void VecTvpWishart::forecast(const std::filesystem::path &filepath_arg)
{
    // Store filepath for later use
    this->filepath = filepath_arg;
...
void VecTvpWishart::log_likelihood(const std::filesystem::path &filepath_arg)
{
    // Store filepath for later use
    this->filepath = filepath_arg;
