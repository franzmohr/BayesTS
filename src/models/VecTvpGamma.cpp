...
void VecTvpGamma::draw_coefficients(const ModelLocation &location_arg)
{
...
void VecTvpGamma::forecast(const ModelLocation &location_arg)
{
    // Store the location for later use
    this->location = location_arg;
...
void VecTvpGamma::log_likelihood(const ModelLocation &location_arg)
{
    // Store the location for later use
    this->location = location_arg;
...
ModelCheck VecTvpGamma::check(const ModelLocation &location_arg)
{
