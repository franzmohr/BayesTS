...
void VarTvpStochvol::draw_coefficients(const ModelLocation &location_arg)
{
...
void VarTvpStochvol::log_likelihood(const ModelLocation &location_arg)
{
    // Store the location for later use
    this->location = location_arg;
...
ModelCheck VarTvpStochvol::check(const ModelLocation &location_arg)
{
