...
// HDF5 front-end for the FavarNormalWishart sampler.
//
// The numerics live in src/core/models/favar_normal_wishart.cpp and know nothing
...
namespace
{
namespace io = bayests::hdf5_io::favar_normal_wishart;
}

FavarNormalWishart::FavarNormalWishart()
{
}
...
void FavarNormalWishart::draw_coefficients(const ModelLocation &location_arg)
{
    ...
    try
    {
        ...
        const bayests::FavarNormalWishartInput input = io::read_input(file);
...
void FavarNormalWishart::forecast(const ModelLocation &location_arg)
{
    // Store the location for later use
    this->location = location_arg;
    ...
    try
    {
        ...
        const bayests::FavarNormalWishartInput input = io::read_input(file);
        const bayests::FavarNormalWishartDraws draws = io::read_coefficients(file);
...
void FavarNormalWishart::log_likelihood(const ModelLocation &location_arg)
{
    // Store the location for later use
    this->location = location_arg;
