...
void VecNormalWishart::draw_coefficients(const ModelLocation &location_arg)
{
...
void VecNormalWishart::forecast(const ModelLocation &location_arg)
{
    // Store the location for later use
    this->location = location_arg;
...
void VecNormalWishart::log_likelihood(const ModelLocation &location_arg)
{
    // Store the location for later use
    this->location = location_arg;
